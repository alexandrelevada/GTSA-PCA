...
Python script to reproduce the results depicted in Table 6
...
#              Data loading
#############################################
# Agglomerative: UMAP x GTSA-PCA-W (Wasserstein distance)
...
#X = skdata.fetch_openml(name='Dexter', version=1)
...
#X = skdata.fetch_openml(name='acute-inflammations', version=1)
#X = skdata.fetch_openml(name='liver-disorders', version=1)
#X = skdata.fetch_openml(name='colic', version=1)
