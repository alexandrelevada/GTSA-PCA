...
Python script to reproduce the results depicted in Table 5
...
#              Data loading
#############################################
# HDBSCAN: Supervised PCA x GTSA-PCA
#X = skdata.load_iris()
...
#X = skdata.fetch_openml(name='arsenic-male-bladder', version=1)
...
# For printing each row of Table 5
